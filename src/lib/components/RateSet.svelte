...
<div class="grid grid-cols-2 w-6">
	<input class="col-span-2" type="text" inputmode="numeric" bind:value={weight} />
...
<div class="grid grid-cols-2 w-6">
	<input class="col-span-2" type="text" inputmode="numeric" bind:value={repetitions} />
